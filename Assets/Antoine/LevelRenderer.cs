...
public class LevelRenderer : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Rayon de la souris par rapport � la cam�ra
        Ray ray = currentCamera.ScreenPointToRay(mousePosition);
        // Cr�ation d'une variable Raycast n�cessaire pour le out de la fonction Raycast
        RaycastHit hit;
    ...
    {
        // Si on est en EditModes && la taille � chang�, on recr�e le level
